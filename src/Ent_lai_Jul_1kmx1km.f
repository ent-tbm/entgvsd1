...
! gfortran -c -cpp -mcmodel=medium -fconvert=big-endian -O2 -fno-range-check -I/usr/local/other/SLES11.3/netcdf/3.6.3/gcc-4.9.2-sp3/include Ent_lai_Jul_1kmx1km.f

! gfortran -o myExe arrayutil.o Ent_lai_Jul_1kmx1km.o -L/usr/local/other/SLES11.3/netcdf/3.6.3/gcc-4.9.2-sp3/lib -lnetcdf
...
!------------------------------------------------------------------------
      ...
      PathFilepost= 'EntMM_lc_lai_Jul_1kmx1km.nc'
      ...
      PathFilepre= '../lc_lai_ent/nc/'
      PathFilepost= 'crops_herb_lc_lai_Jul_1kmx1km.nc'
      filein  =  trim(PathFilepre)//trim(PathFilepost)
...
!-----------------------------------------------------------------
      ...
      end program Ent_lai_Jul_1kmx1km
