...
! gfortran -c -cpp -mcmodel=medium -fconvert=big-endian -O2 -fno-range-check -I/usr/local/other/SLES11.3/netcdf/3.6.3/gcc-4.9.2-sp3/include aggregating_laimont.f
!  gfortran -o myExe arrayutil.o aggregating_laimonth.o -L/usr/local/other/SLES11.3/netcdf/3.6.3/gcc-4.9.2-sp3/lib -lnetcdf
! ./myExe
...
!     FILE IN
      ...
      PathFilepost=  'V1km_EntGVSDv1.1_LAI3g16_lai_Jan_pure.nc'
!      PathFilepost=  'V1km_EntGVSDv1.1_LAI3g16_lai_Jul_pure.nc'
...
!     FILE OUT
      ...
      if (IMout.eq.1440) then
         PathFilepost=  'V1440x720_EntGVSDv1.1_LAI3g16_lai_Jan_pure.nc'
!         PathFilepost=  'V144x90_EntGVSDv1.1_LAI3g16_lai_Jan_pure.nc'
      else
         PathFilepost=  'V144x90_EntGVSDv1.1_LAI3g16_lai_Jan_pure.nc'
!         PathFilepost=  'V144x90_EntGVSDv1.1_LAI3g16_lai_Jan_pure.nc'
      endif
     ...
     *        longout,latout,OFFIB,DLATB, DATMIS)
     ...
     &        start2D,count2D,hout)
      ...
      end program aggregating_laimonth
