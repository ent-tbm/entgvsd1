...
Modis cover is annual, it shouldn't be changing monthly.  Just to be safe, make sure it's preserving cover for that gridcell always, just converting LAI monthly.  Taking the vfc value for cover rather than vfm
Monthly cover 
...
Start Here
  ...
  2x2.5 degree resolution  (will be different at .5 degree)
