...
! gfortran -c -cpp -mcmodel=medium -fconvert=big-endian -O2 -fno-range-check -I/usr/local/other/SLES11.3/netcdf/3.6.3/gcc-4.9.2-sp3/include aggregating_lc.f
!  gfortran -o myExe arrayutil.o aggregating_lc.o -L/usr/local/other/SLES11.3/netcdf/3.6.3/gcc-4.9.2-sp3/lib -lnetcdf
! ./myExe
...
!     FILE OUT
      ...
      if (IMout.eq.1440) then
         PathFilepost=  'V1440x720_EntGVSDv1.1_LAI3g16_lc_pure.nc'
      else
         PathFilepost=  'V144x90_EntGVSDv1.1_LAI3g16_lc_pure.nc'
      endif
     ...
     &        'long_name',44,(EntPFT_title(k))//("- LC"))
         write(*,*) err
         err=NF_PUT_ATT_TEXT(fileidhout,varidhout(k),
     &        'units',8,"fraction")
         write(*,*) err
