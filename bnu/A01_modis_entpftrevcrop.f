...
!     Process BNU LAI, Monfreda, CRU and GPCC climate files into Ent PFT
...
!     Opening file
      ...
      err = NF_INQ_VARID(fileid_lai,'lai',varid_lai)
...
!     write(*,*) err
     ...
     &         'downscaled from 1/12 degree to 1km resolution')
         err = NF_PUT_ATT_TEXT(entpftlaimax_fileid(k),NF_GLOBAL,
     &        'institution',100, 'Original data: BNU LAI,',
     &        'Yuan et al. 2011 RSE 115, 1171-1187')
         err = NF_PUT_ATT_TEXT(entpftlaimax_fileid(k),NF_GLOBAL,
