!* CRU_Temp_Interp_to_1kmx1km.f - Specifically set up to interpolate 0.5º CRU temp files to 1 km resolution
...
!------------------------------------------------------------------------
      ...
      program CRU_Temp_Interp_to_1kmx1km_monthly
...
!       Make and put lon and lat
      ...
      end program CRU_Temp_Interp_to_1kmx1km_monthly
