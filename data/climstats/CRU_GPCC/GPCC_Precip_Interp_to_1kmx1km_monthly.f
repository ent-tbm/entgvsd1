...
!------------------------------------------------------------------------
      ...
      program GPCC_Precip_Interp_to_1kmx1km_monthly
      ...
      character*3, parameter :: MONTH(13) =
     &     (/
...
!      filein =  'GPCC_v6_PREC_means_1981-2010_10kmx10km.nc'
      ...
      do k=1,13
        ...
        !* Output file.
	fileout_pre = 'GPCC_prec_1kmx1km_'
	fileout_sfx = '.nc'
	fileout = 
     &        trim(fileout_pre)// MONTH(k) //
     &        trim(fileout_sfx)
...
!       Make and put lon and lat
      ...
      end program GPCC_Precip_Interp_to_1kmx1km_monthly
