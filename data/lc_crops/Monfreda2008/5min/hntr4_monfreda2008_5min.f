...
C****  Here, keep at 5 min, and just output normalized crop ratios.
...
!  g95 -fno-second-underscore -O2 -fendian=big -cpp hntr4_monfreda2008_5min.f
!  gfortran -cpp -fconvert=big-endian -O0 -fno-range-check hntr4_monfreda2008_5min.f
...
!     5 minute x 5 minute.  This versions does NOT call HNTRP* to 
      ! interpolate to coarser resolutions. Outputs is normalized version;
      ...
      integer, parameter :: longout = IM5M
      integer, parameter :: latout = JM5M
